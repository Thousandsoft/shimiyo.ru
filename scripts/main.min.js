...
var basket$1 = basket = {
    ...
    _refreshCart() {
        ...
        document.querySelectorAll('.cart_quantity_minus').forEach(item => {
            item.addEventListener('click', function (e) {
                basket._minusProduct(e.target.getAttribute('product_id'));
            });
        });

        document.querySelectorAll('.cart_quantity_plus').forEach(item => {
            item.addEventListener('click', function (e) {
                basket._plusProduct(e.target.getAttribute('product_id'));
            });
        });

        document.querySelectorAll('.cart_delete_product_button').forEach(item => {
            item.addEventListener('click', function (e) {
